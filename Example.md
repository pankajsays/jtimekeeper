...
Following example shows a sample of using JTimeKeeper
```
...
`JTimeKeeper[0]^999^OK^consumer:985^processing-start^1380081404504^validation-end^44^data-retrieval-end^178^getStats^84^TOTAL^306`